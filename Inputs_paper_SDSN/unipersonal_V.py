# -*- coding: utf-8 -*-
"""
Created on Wed Mar  9 13:37:24 2022

@author: Clau
Uni-personal family - Valleys
"""
...
U_shower_P = pd.read_csv('TimeSeries/shower_P.csv')
...
U_Microwave = U.Appliance(U,1,800,3,20,0.3,1, occacional_use = 0.2)
U_Microwave.windows([420,540],[720,900],0.3,[1080,1260])

U_water_pump = U.Appliance(U,1,250,2,30,0.3,15, occasional_use = 0.3)
U_water_pump.windows([420,720],[960,1260],0.35)

U_Freezer = U.Appliance(U,1,200,1,1440,0,30,'yes',2)
U_Freezer.windows([0,1440],[0,0])
U_Freezer.specific_cycle_1(5,15,200,15)
U_Freezer.specific_cycle_2(5,20,200,10)
U_Freezer.cycle_behaviour([360,1199],[0,0],[0,359],[1200,1440])

U_shower = U.Appliance(U,1,U_shower_P,2,15,0.1,3, thermal_P_var = 0.2, P_series=True)
